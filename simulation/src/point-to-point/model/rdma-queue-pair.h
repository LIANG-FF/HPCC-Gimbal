...
//这里的一个qp是指流文件里的一个流，真正的qp是指qbb-net-device里的RdmaEgressQueue类
class RdmaQueuePair : public Object {
public:
	Time startTime;
	Ipv4Address sip, dip;		//s: source  d:destination
	uint16_t sport, dport;
	uint64_t m_size;			//一个qp的大小，在构造函数中默认值为0，在rdma-hw.cc中用AddQueuePair函数可以手动设定

	//TCP 滑动窗口数据传输和确认机制http://www.tcpipguide.com/free/t_TCPSlidingWindowDataTransferandAcknowledgementMech-2.htm
	//https://blog.csdn.net/goodlife111/article/details/102459149
